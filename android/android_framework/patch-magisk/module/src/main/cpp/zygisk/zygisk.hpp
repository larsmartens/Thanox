...
extern "C" void zygisk_module_entry(zygisk::internal::api_table *, JNIEnv *) __attribute__((visibility("default"), used));

extern "C" void zygisk_companion_entry(int) __attribute__((visibility("default"), used));
